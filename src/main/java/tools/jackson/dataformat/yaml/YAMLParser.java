 ...
 * name from Jackson library. It was modified to use CoreScalarResolver instead
 * of JsonScalarResolver so that YAML null literals (e.g. '~') are properly
 * recognized as null values for POJO fields.
 */
/**
...
public class YAMLParser extends ParserBase
{
    ...
    // NOTE: Using CoreSchema's resolver (YAML 1.2 Core Schema) instead of JsonScalarResolver
    // so that YAML null literals like '~' are recognized as null for POJO fields.
    protected final ScalarResolver _yamlResolver = new CoreSchema().getScalarResolver();
